...
def top_trips_from(request, n):
	# get the most popular departure stations (n is the number of stations to be returned)
...
def top_trips_to(request, n):
	# get the most popular return stations (n is the number of stations to be returned)
