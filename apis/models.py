...
class Trip(models.Model):
	...
	departure_station_id = models.ForeignKey(Station, null=True, on_delete=models.SET_NULL)
	return_station_id = models.ForeignKey(Station, null=True, on_delete=models.SET_NULL)
